...
<%
		...
		int page_now =(int)session.getAttribute("page");
		ArrayList<BoardVO> page_list = (ArrayList<BoardVO>)session.getAttribute("page_list");
		int page_cnt = (int)session.getAttribute("page_cnt");
%>
</head>
...
<div class="container">
<%
	int page_num = (int)(session.getAttribute("page") );
%>
